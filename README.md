...
En el caso de que queramos explotar un **Log Poisoning** de la manera tradicional nos encontraremos con el inconveniente que vemos en la siguiente captura de pantalla por lo que gracias a este script evitaremos dicho error al usar la librería **paramiko** de **python**.
